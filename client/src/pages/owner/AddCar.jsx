        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
         ...
         <div className='flex flex-col w-full'>
            ...
            <select onChange={e=> setCar({...car, location: e.target.value})} value={car.location} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
              ...
              <option value="Vrindavan Circle">Vrindavan Circle</option>
              <option value="Waghodia Road">Waghodia Road</option>
              <option value="Parivar Cross Road">Parivar Cross Road</option>
              <option value="Bapod Garden">Bapod Garden</option>
            </select>
         </div>
        {/* Car Description */}
         <div className='flex flex-col w-full'>
